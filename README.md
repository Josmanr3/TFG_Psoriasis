...
- **Alta Precisión:** Se alcanzó una **precisión del 92.52%** en el conjunto de prueba final no visto, validando la robustez del enfoque.
...
1.  **Conjunto de Datos:** Se utilizó un dataset de **977 imágenes** recopiladas de fuentes dermatológicas de referencia como DermNet, Roboflow Universe y un conjunto de datos privado
2.  **Preprocesamiento:**
...
4.  **Validación y Evaluación:**
    ...
    - **Validación Cruzada Leave One Out:** Se utilizó para obtener una estimación más robusta del rendimiento del modelo, alcanzando una precisión del **87.51%**.
    - **Evaluación Final:** El modelo final, entrenado con el 85% de los datos, se evaluó en el 15% de prueba, obteniendo una precisión del **92.52%**.
